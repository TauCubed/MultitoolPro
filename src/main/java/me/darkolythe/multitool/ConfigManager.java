...
public class ConfigManager {
    ...
    public void playerLoad(UUID uuid, String invdir) {
        ...
        if (invdir.equals("toolinv.")) {
            Inventory inv = Bukkit.getServer().createInventory(null, InventoryType.DISPENSER, org.bukkit.ChatColor.GREEN + "Multitools"); //create the mv inv
            ...
            Inventory winv = Bukkit.getServer().createInventory(null, InventoryType.HOPPER, org.bukkit.ChatColor.GREEN + "Multiarmour"); //create the mv inv
